...
class KubernetesTab extends mixin(StoreMixin) {
  constructor() {
    super();
...
KubernetesTab.contextTypes = {
  router: React.PropTypes.func
};

module.exports = KubernetesTab;
